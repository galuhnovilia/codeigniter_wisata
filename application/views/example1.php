									...
									<div class="row">
										<div class="col-sm-6 widget-container-col" id="widget-container-col-10">
											<div class="widget-box" id="widget-box-10">
												...
												<li>
											<a href="<?php echo base_url();?>imagesw/<?php echo $row->linkw; ?>" title="Photo Title" data-rel="colorbox">
											<img src="<?php echo base_url();?>imagesw/<?php echo $row->linkw; ?>" width="150" height="150" alt="150x150"/>
											<div class="text">
													...
													foreach ($data->result() as $row) {?>	
														...
														<br/><br/><br/>
															<span class="profile-picture">
																...
																<img class="editable img-responsive" alt="Alex's Avatar" style="width: 100px;height: 100px;"id="avatar2" src="<?php echo base_url();?>imagesw/<?php echo $row->linkw; ?>" />
															</span>
