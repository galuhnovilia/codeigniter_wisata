								...
								<!-- PAGE CONTENT BEGINS -->
									...
									<div id="user-profile-3" class="user-profile row">
										<div class="col-sm-offset-1 col-sm-10">
											...
											<form class="form-horizontal" method="POST" action="<?php echo base_url();?>index.php/admin/simpan">
												<div class="tabbable">
													...
													<div class="tab-content profile-edit-tab-content">
														<div id="edit-basic" class="tab-pane in active">
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-8">
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" name="username" id="username" placeholder="Username"  />
																		</div>
																	</div>
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" name="nama_lengkap" id="nama_lengkap" placeholder="Nama Lengkap"  />
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																		<select class="chosen-select form-control" name='user' id=user required data-placeholder="Pilih level user..">
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																<input class="input-medium" type="text" id="tempat" name="tempat" placeholder="Tempat" /> 
																...
																<div class="col-sm-9">
																	<div class="input-medium">
																		<div class="input-group">
																			<input class="input-medium date-picker" id="tgl_lahir" name="tgl_lahir"type="text" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd"  />
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<span class="input-icon input-icon-right">
																		<input class="input-medium input-mask-phone" type="text" id="no_telp" name="no_telp" placeholder="(9999) 999-9999" />
					   ...
					   <div class="modal-content">\
						...
						<form class="no-margin">\
						 <div class="modal-body">\
							<div class="space-4"></div>\
							<div style="width:75%;margin-left:12%;"><input type="file" name="foto" id="foto" /></div>\
						 </div>\
						\
