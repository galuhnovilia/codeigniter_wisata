													...
													<div class="tab-content profile-edit-tab-content">
														<div id="edit-basic" class="tab-pane in active">
															...
															<div class="row">
																...
																<input type="file" name="foto" id="foto" placeholder="Foto" class="span1" >
																<br/>
																new :<br/>
										...
										<!--<i><input id="linkk" type="file" name="linkk" placeholder="Link Gambar" onchange="PreviewImage();" class="span1" value="<?php echo $linkk;?>"></input></i>-->
																...
																<div class="col-xs-12 col-sm-8">
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																		<input class="col-xs-12 col-sm-10" type="text" name="nama_lengkap" id="user" placeholder="user"  disabled />
