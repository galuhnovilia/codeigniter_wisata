									...
									<div id="user-profile-1" class="user-profile row">
										<div class="col-xs-12 col-sm-3 center">
											<div>
												...
												<img class="editable img-responsive" src=<?php echo" http://localhost/wisataCilacap/imagesp/".$this->session->userdata('foto'); ?> />
												...
												<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
													<div class="inline position-relative">
														<a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
															<i class="glyphicon 	glyphicon-camera   orange"></i>
															&nbsp;
															<span class="white"><?php
										$user=$this->session->userdata('username');
										echo $user 
										//<?php echo $this->load->view($content);?> </span>
														</a>
											...
											<div class="profile-contact-info">
												<div class="profile-contact-links align-left">
														...
														<i class="ace-icon fa fa-google  bigger-120 red"></i>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<?php
										...
										<div class="col-xs-12 col-sm-9">
											...
											<div class="profile-info-row">
													<div class="profile-info-name">Id Username </div>

													<div class="profile-info-value">
														<span class="editable" id="#"><?php
																			$id=$this->session->userdata('id_username');
																			echo $id
																			?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="#"><?php
																			$user1=$this->session->userdata('akun');
																			echo $user1
																			?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<div class="profile-info-value"><span class="editable" id="#"><?php
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<div >
														<a class="green" href="<?php echo base_url();?>index.php/profil/edit/<?php echo $this->session->userdata('id_username'); ?>">
