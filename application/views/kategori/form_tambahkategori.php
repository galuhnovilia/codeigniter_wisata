															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-8">
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" name="nama_kategori" id="nama_kategori" placeholder="nama"  />
																		</div>
																	</div>

																<div class="form-group" >
																<label class="col-sm-4 control-label no-padding-right" for="form-field-date">Icon </label>
																<div class="col-sm-9" style="width: 300px;height: 100px;">
																<img id="uploadPreview" style="width: 100px; height: 100px;" ></img><br/><br/>
										
																<input id="icon" type="file" name="icon" onchange="PreviewImage();" class="span1" ></input>
